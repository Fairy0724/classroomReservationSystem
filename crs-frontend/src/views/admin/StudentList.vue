    ...
    <div class="page-card">
      ...
      <div class="toolbar">
        <div class="toolbar-left">
          <el-input v-model="query.keyword" placeholder="姓名 / 账号 / 手机 / 邮箱 / 学号" clearable @keyup.enter="handleSearch"
            style="width: 260px" />
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="520px">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
        <el-form-item label="账号" prop="username">
          <el-input v-model="form.username" placeholder="请输入学生账号" />
        </el-form-item>
...
const handleDelete = (row) => {
  ElMessageBox.confirm(`确认删除学生“${row.realName || row.username}”吗？`, '提示', {
    type: 'warning'
  }).then(async () => {
